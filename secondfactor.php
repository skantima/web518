...
<head>
    ...
    <style>
        ...
        .bg { 
            /* The image used */
            background-image: url("highsecurity.jpg");
            /* Full height */
            height: 100%; 
...
<body  class="bg">
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3"  style="background: white; padding: 20px;  margin-top: 100px;">
                <h1 style="text-align: center;">Scan the QR code</h1>
                <p style="font-style: italic;margin-left: 140px;">Powered by Google Authenticator</p>
                <hr>
