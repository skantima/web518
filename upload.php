    ...
    $user_id = $_SESSION['user_id'];
  	...
  	move_uploaded_file($_FILES["file"]["tmp_name"], $location);
  	 ...
  	 if($run){
          ...
          $g_posts = "SELECT * FROM posts INNER JOIN users WHERE posts.group_id='$group_id' and users.user_id=posts.user_id and users.posts = 'yes' and posts.image_content = '$name'";
